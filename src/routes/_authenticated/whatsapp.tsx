...
import { MessageCircle, Send, Search, UserPlus, WifiOff } from "lucide-react";
...
function WhatsappPage() {
  ...
  return <div className="space-y-6">
    <header className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between"><div><p className="text-xs font-semibold uppercase tracking-[.16em] text-primary">Central de conversas</p><h1 className="mt-1 text-3xl font-semibold tracking-tight">WhatsApp</h1><p className="mt-1.5 text-sm text-muted-foreground">Registre a conversa no CRM e mantenha o próximo passo visível.</p></div><Badge variant="outline" className="w-fit rounded-full"><WifiOff className="mr-1.5 size-3" />Modo de registro</Badge></header>
